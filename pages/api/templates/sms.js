...
export default async function handler(req, res) {
  ...
  // POST /api/templates/sms — create new template
  if (req.method === "POST") {
    const { name, body, variables, is_default } = req.body || {};
  ...
  // PATCH /api/templates/sms?id=uuid — update template
  if (req.method === "PATCH") {
    const { id } = req.query;
  ...
  // DELETE /api/templates/sms?id=uuid
